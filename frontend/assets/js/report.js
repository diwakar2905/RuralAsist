                ...
                html += `
                    <div class="col-md-6 mb-3">
                        <div class="card h-100 border-left-danger" style="border-left: 4px solid #dc3545;">
                            <div class="card-body">
                                <h6 class="card-title fw-bold">${scam.type}</h6>
                                <p class="card-text small mb-2">${scam.description}</p>
                                <div class="alert alert-sm alert-warning py-2 px-3 mb-2">
                                    <small><strong>${scam.warning}</strong></small>
                                </div>
                                <small class="text-muted">
                                    <strong>Examples:</strong><br>
                                    ${scam.examples.map(ex => `• ${ex}`).join('<br>')}
                                </small>
                            </div>
                        </div>
                    </div>
